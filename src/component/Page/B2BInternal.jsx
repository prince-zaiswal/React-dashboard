...
// data
import {B2bonline, B2breview, B2bpublicData, B2bhealth} from '../data/InternalData.js';

function B2BInternal() {
  return (
    <div className='p-3 md:p-0'>
    <h2 className='font-medium text-xl text-black mt-5'>Internal</h2>
    <h3 className='font-medium text-gray-400 text-[14px]'>B2B - Internal - Research</h3>
