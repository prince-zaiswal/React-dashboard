...
// data
import {B2conline, B2creview, B2cpublicData, B2chealth} from '../data/ExternalData.js';

function B2CExternal() {
  return (
    <div className='p-3 md:p-0'>
      <h2 className='font-medium text-xl text-black mt-5'>External</h2>
      <h3 className='font-medium text-gray-400 text-[14px]'>B2C - External - Research</h3>
