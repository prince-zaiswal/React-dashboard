...
import {B2conline, B2creview, B2cpublicData, B2chealth} from '../data/InternalData.js';

function B2CInternal() {
  return (
    <div className='p-3 md:p-0'>
    <h2 className='font-medium text-xl text-black mt-5'>Internal</h2>
    <h3 className='font-medium text-gray-400 text-[14px]'>B2C - Internal - Research</h3>
        ...
        <div className='bg-white pb-4  rounded-lg px-4  md:w-1/2'>
          ...
          <div className='h-[350px] overflow-y-scroll'>
            <table className=" leading-normal overflow-x-auto h-1/4 w-full text-center">
              ...
              <tbody >
                {B2conline && B2conline.map((item, index) => <tr>
        ...
        <div className='bg-white   pb-4 rounded-lg mt-5 md:mt-0 px-4 md:w-1/2'>
          ...
          <div className='h-[350px] overflow-y-scroll'>
            <table className=" leading-normal overflow-x-auto h-1/4 w-full text-center">
              ...
              <tbody >
                {B2creview && B2creview.map((item, index) => <tr>
                  <td className="py-3 p-1 border-b cursor-pointer text-blue-700 border-gray-200 bg-white text-sm">
                    {item['Reviewer Name']}
                  </td>
                  <td className=" py-3 p-1 border-b border-gray-200 bg-white text-sm">
        ...
        <div className='bg-white pb-4  rounded-lg px-4  md:w-1/2'>
          ...
          <div className='h-[350px] overflow-y-scroll'>
            <table className=" leading-normal overflow-x-auto h-1/4 w-full text-center">
              ...
              <tbody >
                {B2cpublicData && B2cpublicData.map((item, index) => <tr>
                  <td className="py-3 p-1 border-b cursor-pointer text-blue-700 border-gray-200 bg-white text-sm">
                    {item['Reviewer Name']}
                  </td>
                  <td className="py-3 p-1 border-b border-gray-200 bg-white text-sm">
        ...
        <div className='bg-white   pb-4 rounded-lg mt-5 md:mt-0 px-4 md:w-1/2'>
          ...
          <div className='h-[350px] overflow-y-scroll'>
            <table className=" leading-normal overflow-x-auto h-1/4 w-full text-center">
              ...
              <tbody >
                {B2chealth && B2chealth.map((item, index) => <tr>
                  <td className="py-3 p-1 border-b cursor-pointer text-blue-700 border-gray-200 bg-white text-sm">
                    {item['Reviewer Name']}
                  </td>
                  <td className="py-3 p-1 border-b border-gray-200 bg-white text-sm">
