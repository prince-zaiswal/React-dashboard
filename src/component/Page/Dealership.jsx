...
import { monthlyDataDealership } from '../data/SalesMarketing'
// ChartsJs
...
function Dealership() {
  ...
  const months = monthlyDataDealership.map(data => data.month);
  const salesData = monthlyDataDealership.map(data => data.sales.revenue);
  const spendData = monthlyDataDealership.map(data => data.marketing.spend);
  const units = monthlyDataDealership.map(data => data.sales.units);
 ...
 const options = {
  ...
  return (
    ...
    <h2 className='font-medium text-xl text-black mt-5'>Dealership</h2>
    <h3 className='font-medium text-gray-400 text-[14px]'>Sales/Marketing - Dealership</h3>
        ...
        <div className=' px-4 border-gray-200 '>
          <div className=" py-4 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {monthlyDataDealership.map((monthData, index) => (
