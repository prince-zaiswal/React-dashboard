...
// data
import {B2bonline, B2breview, B2bpublicData, B2bhealth, B2conline, B2creview, B2cpublicData, B2chealth} from '../data/InternalData.js';
...
function Internal() {
  return (
    ...
    <h3 className='font-medium text-gray-400 text-[14px]'>Reasearch - Internal</h3>
